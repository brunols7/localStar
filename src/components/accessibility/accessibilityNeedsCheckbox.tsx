...
import { AccessibilityCheck } from '@/types/accessibilityCheck';
import { Check } from 'lucide-react-native';
import { StyleSheet, Text, TouchableOpacity, View } from 'react-native';

type Props = AccessibilityCheck;

export default function AccessibilityNeedsCheckbox({ name, icon: Icon, onPress, isChecked }: Props) {
